...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <asp:Label runat="server" ForeColor="#FF6347" Text="Ready to learn how to Attract, Recruit & Retain talents with WeChat?" Font-Size="X-Large"></asp:Label>
    <div style="margin-top: 12px">
        <asp:Label runat="server" Text="Please fill in the following details to register for the WeChat Recruitment 2.0 Seminar:" Font-Size="Medium"></asp:Label>
    </div>
    <div>
        <div style="margin-top: 13px" runat="server">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                ErrorMessage="The name field cannot be empty！" ControlToValidate="nameText" ForeColor="Red"></asp:RequiredFieldValidator><br />
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                ErrorMessage="The company field cannot be empty！" ControlToValidate="companyText" ForeColor="Red"></asp:RequiredFieldValidator><br />
    ...
    <div style="margin-top: 18px">
        <asp:Button runat="server" CssClass="btnRegister" Text="Register now." ID="btnSubmit" OnClick="Register_Click" CausesValidation="true" />
    </div>
</asp:Content>
