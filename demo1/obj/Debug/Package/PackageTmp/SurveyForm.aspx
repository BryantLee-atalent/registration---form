...
<asp:Content ID="Content1" ContentPlaceHolderID="SurveyForm" runat="server">
    ...
    <div>
        ...
        <div class="formStyle">
            ...
            <div style="border-top:dashed 1px;border-bottom:dashed 1px;border-bottom-color:tomato;border-top-color:tomato; margin-bottom:5px">
            ...
            <div style="border-bottom:dashed 1px;border-bottom-color:tomato; margin-bottom:5px">
        ...
        <asp:Button runat="server" CssClass="btnStyle" Text="Submit" OnClick="Submit_Click" ID="submit" />
    </div>
</asp:Content>
